...
{% include button.html text="GitHub" icon="github" link="https://github.com/claireroche" color="#0366d6" %} {% include button.html text="ORCID" icon="/images/ID.png" link="https://github.com/claireroche" color="#0366d6" %}
